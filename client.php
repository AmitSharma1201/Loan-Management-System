  ...
  echo "  <div class='form-group'>
	...
	//echo "cnt_name=$label_name";
        if($cnt_type=="text"||$cnt_type=="password"||$cnt_type=="file"){
		 /*if($label_name=="Account number"){
			     echo "<input type='$cnt_type' name='$label_name' class='form-control' maxlength='16' required/>";}
		    else if($label_name=="IFSC code"){
			echo "<input type='$cnt_type' name='$label_name' class='form-control' maxlength='11' required/>";}
            */
	...
	//	echo "checkbox label_name=$label_name";
		...
		echo "<textarea name='$label_name' class='form-control' rows=5 cols=10 required>adress1</textarea>";	
